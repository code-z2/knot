...
struct SendMoneyScanView: View {
    ...
    private func errorTitle(_ error: QRScannerError) -> String {
        ...
        case .permissionDenied:
            String(localized: "send_money_scanner_camera_access_needed")
        case .unavailable:
            String(localized: "send_money_scanner_camera_unavailable")
        case .configurationFailed:
            String(localized: "send_money_scanner_unavailable")
        }
    }
    ...
    private func errorSubtitle(_ error: QRScannerError) -> String {
        switch error {
        case .permissionDenied:
            String(localized: "send_money_scanner_permission_subtitle")
        case .unavailable:
            String(localized: "send_money_scanner_unavailable_subtitle")
        case .configurationFailed:
            String(localized: "send_money_scanner_config_subtitle")
        }
    }
