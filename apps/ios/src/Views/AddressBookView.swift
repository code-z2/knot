    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: 14) {
                    field(title: "add_beneficiary_name", text: $name, placeholder: "add_beneficiary_placeholder_name")
                    field(title: "add_beneficiary_wallet_address", text: $address, placeholder: "add_beneficiary_placeholder_address")
                    field(title: "add_beneficiary_chain_optional", text: $chain, placeholder: "add_beneficiary_placeholder_chain")
