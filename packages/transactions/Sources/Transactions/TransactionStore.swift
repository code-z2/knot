...
public final class TransactionStore {
    ...
    private var lastAccumulatorAddress: String?
    ...
    public func refresh(walletAddress: String, accumulatorAddress: String? = nil) async {
        ...
        if let accumulatorAddress, !accumulatorAddress.isEmpty {
            lastAccumulatorAddress = accumulatorAddress
        }
        isLoading = true
        error = nil
        currentCursor = nil
        ...
        await performFetch(
            ...
            accumulatorAddress: accumulatorAddress ?? lastAccumulatorAddress,
            cursor: nil,
            replace: true,
        )
    }
    ...
    public func silentRefresh() async -> Bool {
        ...
        await performFetch(
            ...
            accumulatorAddress: lastAccumulatorAddress,
            cursor: nil,
            replace: true,
        )
        return true
