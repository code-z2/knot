...
public struct TransactionRecordModel: Identifiable, Hashable, Sendable, Codable {
    /// Unique ID: "chainId:txHash" for single-chain, "mc:txHash" for multichain
    public let id: String
    public let status: TransactionRecordStatus
    public let variant: TransactionRecordVariant
    ...
    public init(
        ...
        variant: TransactionRecordVariant,
        chainId: UInt64,
        chainName: String,
        txHash: String,
        fromAddress: String,
...
public struct TransactionDateSectionModel: Identifiable, Hashable, Sendable, Codable {
    public let id: String
    public let title: String
    public let transactions: [TransactionRecordModel]

    public init(id: String, title: String, transactions: [TransactionRecordModel]) {
        self.id = id
        self.title = title
...
public struct TransactionPageModel: Sendable, Codable {
    public let sections: [TransactionDateSectionModel]
    public let cursorAfter: String?
    public let hasMore: Bool

    public init(sections: [TransactionDateSectionModel], cursorAfter: String?, hasMore: Bool) {
