...
///
/// SpokePool addresses come from `ChainRegistry`.
public struct AcrossBridgeProvider: BridgeProvider, Sendable {
    ...
    public func canBridge(token: String, sourceChain: UInt64, destChain: UInt64) -> Bool {
        ...
        guard ChainRegistry.spokePoolAddress(chainID: sourceChain) != nil,
              ChainRegistry.spokePoolAddress(chainID: destChain) != nil
        else {
            return false
        }
